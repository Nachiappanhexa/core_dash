...
@Component({
  selector: 'app-tableviewups',
  templateUrl: './tableviewups.component.html',
  styleUrl: './tableviewups.component.css'
})
export class TableviewupsComponent implements OnChanges {
  @Input() data: ups[] = [];
