...
@Component({
  selector: 'app-tableviewdailyback',
  templateUrl: './tableviewdailyback.component.html',
  styleUrl: './tableviewdailyback.component.css'
})

export class TableviewdailybackComponent {
  @Input() data: DailyBackup[] = [];
  fileName: string = 'dailyBackup_Reports_'+new Date().toISOString().replace(/\D/g, '').replace(/-/g, '');
