...
@Component({
  selector: 'app-tableviewnetwork',
  templateUrl: './tableviewnetwork.component.html',
  styleUrl: './tableviewnetwork.component.css'
})
export class TableviewnetworkComponent {
  @Input() data: SwitchPing[] = [];
  fileName: string = 'Network_Reports_' + new Date().toISOString().replace(/\D/g, '').replace(/-/g, '');
