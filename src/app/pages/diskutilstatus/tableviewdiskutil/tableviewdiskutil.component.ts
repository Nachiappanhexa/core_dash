...
@Component({
  selector: 'app-tableviewdiskutil',
  templateUrl: './tableviewdiskutil.component.html',
  styleUrl: './tableviewdiskutil.component.css'
})
export class tableviewdiskutilComponent {
  @Input() data: Diskutil[] = [];
