...
@Component({
  selector: 'app-tableviewdisk',
  templateUrl: './tableviewdisk.component.html',
  styleUrl: './tableviewdisk.component.css'
})

export class TableviewdiskComponent {
  @Input() data: RAIDModel[] = [];
  fileName: string = 'Raiddisk_Reports_'+new Date().toISOString().replace(/\D/g, '').replace(/-/g, '');
