...
import { dashboard, Pingreport, TillsStatus } from '../../../models/fullmodels';
...
@Component({
  selector: 'app-tableviewtill',
  templateUrl: './tableviewtill.component.html',
  styleUrl: './tableviewtill.component.css'
})
export class TableviewtillComponent implements OnChanges {
  @Input() data: TillsStatus[] = [];
  fileName: string = 'Tills_Reports_'+new Date().toISOString().replace(/\D/g, '').replace(/-/g, '');
